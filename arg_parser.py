...
parser.add_argument('--test-set', action='store_true', help='use test set for evaluation')
parser.add_argument('--parameters', action='store_true', help='use best parameters')
...
parser.add_argument('--y-csv-path', type=str, default='', help='path to the csv file containing the cell x cell type matrix')
parser.add_argument('--test-path', type=str, default='', help='path to the test h5ad file representing an Anndata object')
parser.add_argument('--parameters-path', type=str, default='', help='path to pickled parameters object')
parser.add_argument('--bulk-path', type=str, default='', help='path to the bulk h5ad file representing an Anndata object')
